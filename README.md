...
Translator v3.0 的软件主界面

![TranslatorIntroduction](TranslatorIntroduction/TranslatorIntroduction.jpg)
...
* 空闲复习
* 多种发音
* 更多功能请参考`TranslatorIntroduction/TranslatorIntroduction.jpg`



### Built With
依赖
* [Visual Studio IDE, Code Editor, Azure DevOps, & App Center ...](https://visualstudio.microsoft.com/)
...
> 请在你的windows上面安装最新版的visual studio。
...
2. 找到对应版本的`*.sln`文件，并用visual studio将它打开。
